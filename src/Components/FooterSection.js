    ...
    <FooterSectionStyle>
      <Container>
        <Row className="footerRow">
          ...
          <div className="col-3">
            <Row>
              <FooterTitleStyle>Useful Links</FooterTitleStyle>
            </Row>
            <Row>
              <FooterSubTitleStyle>Overviews</FooterSubTitleStyle>
            </Row>
            <Row>
              <FooterSubTitleStyle>Timeline</FooterSubTitleStyle>
            </Row>
            <Row>
              <FooterSubTitleStyle>FAQs</FooterSubTitleStyle>
            </Row>
            <Row>
              <FooterSubTitleStyle>Register</FooterSubTitleStyle>
            </Row>
            <Row>
              <FollowTextStyle>
                Follow us
          ...
          <div className="col-3">
            <Row>
              <FooterTitleStyle>Contact Us</FooterTitleStyle>
            </Row>
            <Row>
              <FooterSubTitleStyle>
                <svg
...
const GetLinkedStyle = styled.div`
  color: #fff;
...
const GetLinkedFooterSubStyle = styled.div`
  width: 80%;
`;
...
const FooterSubTitleStyle = styled.div`
  padding: 1% 0;
  color: #fff;
  font-family: Montserrat;
  font-size: 12px;
